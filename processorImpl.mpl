...
] "processorPrepare" exportFunction
...
] "processorFinalize" exportFunction
...
donotcomp:[
  {
    ...
    processor.options.debug [
      ...
      [
        i processor.options.fileNames.dataSize < [
          id: i processor.options.fileNames.at makeStringView addModuleDebugInfo;
    ...
    multiParserResult.nodes.dataSize 0 > [
      ...
      runFile: [
        ...
        n dynamic @rootPositionInfo.@moduleId set
